...
/**
 * Parser that extracts package information from a text-based network traffic
 * snapshot
 * 
 * @author Javier Verde
 *
...
public abstract class DefaultSnapshotTxtBasedParser {
	 ...
	 */
	protected final ProcessedLength processLength(ITrafficSnapshot snapshot, int initPointer, String nameLayer)
			throws ParseSnapshotException {
