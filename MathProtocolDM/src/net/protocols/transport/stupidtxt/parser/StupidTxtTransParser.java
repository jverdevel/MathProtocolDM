 ...
 *
 */
public class StupidTxtTransParser extends DefaultSnapshotTxtBasedParser
		implements IPortCompatibleTransportProtocolParser {
	...
	public PortCompatibleTransportPacket processPackage(ITrafficSnapshot snapshot) throws ParseSnapshotException {
		...
		ITrafficSnapshot remains = snapshot.getSnapshotFragment(dataLength.getStart(),
				dataLength.getStart() + dataLength.getLength());
