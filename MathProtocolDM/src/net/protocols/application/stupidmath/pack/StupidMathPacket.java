...
public class StupidMathPacket implements IApplicationLayerPacket {
	...
	public static final Set<String> VALID_OPERATIONS = Set.of(OPERATION_SUM, OPERATION_MINUS, OPERATION_PRODUCT,
			OPERATION_DIVIDE, OPERATION_RESULT);
	 ...
	 * @param operand1   first operand. Use USE_PREVIOUS_OPERAND if packet tells to
	 *                   call previous operand
	 * @param operand2   second operand. Use USE_PREVIOUS_OPERAND if packet tells to
	 *                   call previous operand, If the operation is result, this is
	 *                   always 0
	 */
	...
	private void validateSecondOperandResult(String operation, int operand2) {
		if (operation.equals(OPERATION_RESULT) && operand2 != EXPECTED_OPERAND_2_RESULT) {
			throw new IllegalArgumentException(
					"Second operand should be " + EXPECTED_OPERAND_2_RESULT + " for a result operation");
		}
	}
	...
	public String toString() {
		return "StupidMathPacket [operation=" + operation + ", operand1=" + operand1 + ", operand2=" + operand2 + "]";
	}
