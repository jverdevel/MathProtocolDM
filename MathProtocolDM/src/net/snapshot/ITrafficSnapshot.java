...
public interface ITrafficSnapshot {
	...
	/**
	 * VV: Gets the string at the indicated position. Please notice this WILL copy the values in a different String, so only use it for final processing
	...
	/**
	 * VV: Gets another fragment that goes from one position to other. Implementation should NOT duplicate the data source under any circustances. 
	 * @param from start position (included) 
	 * @param to
