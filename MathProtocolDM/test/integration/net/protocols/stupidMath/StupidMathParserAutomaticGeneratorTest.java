...
/**
 * This is a generator of large Comm sets that can be turned into Strings and put back into comms, so we don't have to generate too big strings automatically
 * @author Javier Verde
 *
 */
public class StupidMathParserAutomaticGeneratorTest extends ParserAutomaticGeneratorTest<StupidMathOp>{
	...
	private static final String[] VALID_NON_RESPONSE_OPERATIONS = new String[] {StupidMathPacket.OPERATION_SUM, StupidMathPacket.OPERATION_MINUS, StupidMathPacket.OPERATION_PRODUCT, StupidMathPacket.OPERATION_DIVIDE};
	...
	/**
	 * Obtains a random integer value for operation, allowing for some chance of "use previous value" (*)
	 * @param random randomness generator
	 * @return operand
	 */
